...
public class Old_MenuMain:GUIBehaviour {
	...
	private Old_MenuCredits menuCredits;
	...
	void Start() {
		...
		menuOptions = GetComponent<Old_MenuOptions>();
		menuCredits = GetComponent<Old_MenuCredits>();
	}
